...
- **Multiple deployment targets** — runs as an npm package (`npx`), Docker container, GitHub Actions service container, or EKS deployment. Published to npmjs.com, GitHub Packages (npm), and GHCR (Docker).
...
- **All-GitHub ecosystem** — npm on npmjs.com + GitHub Packages, Docker on GHCR, CI on GitHub Actions, discovery on GitHub Pages
